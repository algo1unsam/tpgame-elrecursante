...
object hordaUno inherits Horda{
	...
	override method configurate(){
		...
		//Genero enemigos 
		const orco1 = new Enemigo(velocidad=1000,image="enemigos/orco.png", position = game.at(5, 1))
		const orco2 = new Enemigo(velocidad=800,image="enemigos/orco.png", position = game.at(17, 0))
		const orco3 = new Enemigo(velocidad=1200,image="enemigos/orco.png", position = game.at(1, 2))
		const orco4 = new Enemigo(velocidad=1200,image="enemigos/orco.png", position = game.at(19, 1))	
		const orco5 = new Enemigo(velocidad=1000,image="enemigos/orco.png", position = game.at(7, 3))
...
object hordaDos inherits Horda{
	...
	override method configurate(){
		...
		//Genero Enemigos
		const orco1 = new Enemigo(velocidad=1000,image="enemigos/orco.png", position = game.at(26, 1))
		const orco2 = new Enemigo(velocidad=1000,image="enemigos/orco.png", position = game.at(23, 2))
		...
		const urukhai3 = new Enemigo(velocidad=800,image="enemigos/urukhai.png", position = game.at(3, 3))
...
object hordaTres inherits Horda{
	...
	override method configurate(){
		super()
		const urukhai1 = new Enemigo(vida=2,velocidad=500,image="enemigos/urukhai.png", position = game.at(1, 0))
		const urukhai2 = new Enemigo(vida=2,velocidad=500,image="enemigos/urukhai.png", position = game.at(9, 0))
		const urukhai3 = new Enemigo(vida=2,velocidad=1000,image="enemigos/urukhaiEscudo.png", position = game.at(19, 0))
		const urukhai4 = new Enemigo(vida=2,velocidad=1200,image="enemigos/urukhaiEscudo.png", position = game.at(18, 2))
		const urukhai5 = new Enemigo(vida=2,velocidad=700,image="enemigos/urukhaiEscudo.png", position = game.at(20, 4))
		const urukhai6 = new Enemigo(vida=4,velocidad=800,image="enemigos/urukhaiEscudo.png", position = game.at(3, 3))
		const urukhai7 = new Enemigo(velocidad=900,image="enemigos/urukhaiEscudo.png", position = game.at(18, 4))	
		const orco1 = new Enemigo(velocidad=1000,image="enemigos/orco.png", position = game.at(5, 3))
		const orco2 = new Enemigo(velocidad=800,image="enemigos/orco.png", position = game.at(17, 2))
		const orco3 = new Enemigo(velocidad=1200,image="enemigos/orco.png", position = game.at(1, 1))
		orco1.ejecutarMovimiento()
		orco2.ejecutarMovimiento()
		orco3.ejecutarMovimiento()
